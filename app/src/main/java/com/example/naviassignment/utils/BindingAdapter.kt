...
import com.example.naviassignment.utils.Constants.Companion.UI_DATE_TIME_FORMAT
...
object BindingAdapter {
    ...
    private val requiredDateFormatter = SimpleDateFormat(UI_DATE_TIME_FORMAT, Locale.getDefault())
                ...
                this.apply {
                    text = if (isCreated) {
                        this.context.getString(
                            R.string.created_on,
                            requiredDateFormatter.format(date)
                        )
                    } else {
                        this.context.getString(
                            R.string.closed_on,
